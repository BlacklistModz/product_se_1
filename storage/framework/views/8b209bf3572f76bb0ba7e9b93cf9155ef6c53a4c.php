		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div><span style="font-weight: bold;"><?php echo e($value->name); ?></span></div>
						<div style="font-size: 10pt;">
							ประเภท : <span style="color: gray;"><?php echo e($value->typename); ?></span>
						</div>
						<div style="font-size: 10pt;">
							ร้าน : <span style="color: gray;"><?php echo e($value->storename); ?></span>
						</div>
					</td>
